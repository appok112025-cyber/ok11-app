...
class StatusTheme {
  static final Map<MatchStatus, _StatusColors> _themes = {
    MatchStatus.upcoming: _StatusColors(
      header: AppColors.accentBlue.withValues(alpha: 0.15),
      text: AppColors.accentBlue,
      border: AppColors.accentBlue.withValues(alpha: 0.3),
      shadow: AppColors.accentBlue.withValues(alpha: 0.12),
      badge: AppColors.accentBlue,
      badgeBorder: AppColors.accentBlue.withValues(alpha: 0.5),
      badgeText: Colors.white,
      textLabel: 'upcoming',
    ),
    MatchStatus.live: _StatusColors(
      header: AppColors.accentGreen.withValues(alpha: 0.2),
      text: AppColors.accentGreen,
      border: AppColors.accentGreen.withValues(alpha: 0.4),
      shadow: AppColors.accentGreen.withValues(alpha: 0.15),
      badge: AppColors.accentGreen,
      badgeBorder: AppColors.accentGreen.withValues(alpha: 0.7),
      badgeText: Colors.white,
      textLabel: 'Live',
    ),
    MatchStatus.completed: _StatusColors(
      header: AppColors.accentPurple.withValues(alpha: 0.15),
      text: AppColors.accentPurple,
      border: AppColors.accentPurple.withValues(alpha: 0.3),
      shadow: AppColors.accentPurple.withValues(alpha: 0.12),
      badge: AppColors.accentPurple,
      badgeBorder: AppColors.accentPurple.withValues(alpha: 0.5),
      badgeText: Colors.white,
      textLabel: 'completed',
    ),
